 ...
 * @author rubensworks
 */
public class AbilityTypeBonemealerSerializerConfig extends AbilitySerializerConfig<AbilityTypeBonemealer> {

    public AbilityTypeBonemealerSerializerConfig() {
        super("bonemealer", (eConfig) -> RecordCodecBuilder.create(builder -> builder
                ...
                .apply(builder, AbilityTypeBonemealer::new))
        );
    }
}
