 ...
 *
 */
public class AbilityStrengthConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityStrengthConfig() {
        super("strength",
                eConfig -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(), rarity, maxLevel, xpPerLevel, Effects.STRENGTH));
    }
