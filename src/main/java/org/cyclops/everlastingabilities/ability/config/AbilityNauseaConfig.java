 ...
 *
 */
public class AbilityNauseaConfig extends AbilityConfig<AbilityTypePotionEffectRadius> {
    ...
    public AbilityNauseaConfig() {
        super("nausea",
                eConfig -> new AbilityTypePotionEffectRadius(eConfig.getNamedId(), rarity, maxLevel, xpPerLevel, Effects.NAUSEA));
    }
