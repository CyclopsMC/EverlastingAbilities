 ...
 *
 */
public class AbilitySlownessConfig extends AbilityConfig<AbilityTypePotionEffectRadius> {
    ...
    public AbilitySlownessConfig() {
        super("slowness",
                eConfig -> new AbilityTypePotionEffectRadius(eConfig.getNamedId(), () -> rarity, () -> maxLevel, () -> xpPerLevel,
                        () -> obtainableOnPlayerSpawn, () -> obtainableOnMobSpawn, () -> obtainableOnCraft, () -> obtainableOnLoot, MobEffects.MOVEMENT_SLOWDOWN));
    }
