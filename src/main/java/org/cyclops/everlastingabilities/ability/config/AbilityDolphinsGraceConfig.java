 ...
 *
 */
public class AbilityDolphinsGraceConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityDolphinsGraceConfig() {
        super("dolphins_grace",
                eConfig -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(), () -> rarity, () -> maxLevel, () -> xpPerLevel,
                        () -> obtainableOnPlayerSpawn, () -> obtainableOnMobSpawn, () -> obtainableOnCraft, () -> obtainableOnLoot, MobEffects.DOLPHINS_GRACE));
    }
