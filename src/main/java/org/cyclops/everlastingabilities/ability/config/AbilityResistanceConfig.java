 ...
 *
 */
public class AbilityResistanceConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityResistanceConfig() {
        super("resistance",
                eConfig -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(), () -> rarity, () -> maxLevel, () -> xpPerLevel,
                        () -> obtainableOnPlayerSpawn, () -> obtainableOnMobSpawn, () -> obtainableOnCraft, () -> obtainableOnLoot, MobEffects.DAMAGE_RESISTANCE));
    }
