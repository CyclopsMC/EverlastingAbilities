 ...
 *
 */
public class AbilityBlindnessConfig extends AbilityConfig<AbilityTypePotionEffectRadius> {
    ...
    public AbilityBlindnessConfig() {
        super("blindness",
                eConfig -> new AbilityTypePotionEffectRadius(eConfig.getNamedId(), rarity, maxLevel, xpPerLevel, Effects.BLINDNESS));
    }
