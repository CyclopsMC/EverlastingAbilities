 ...
 *
 */
public class AbilityJumpBoostConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityJumpBoostConfig() {
        super("jump_boost",
                eConfig -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(), rarity, maxLevel, xpPerLevel, Effects.JUMP_BOOST));
    }
