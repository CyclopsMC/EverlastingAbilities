 ...
 *
 */
public class AbilityHasteConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityHasteConfig() {
        super("haste",
                eConfig -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(), () -> rarity, () -> maxLevel, () -> xpPerLevel,
                        () -> obtainableOnPlayerSpawn, () -> obtainableOnMobSpawn, () -> obtainableOnCraft, () -> obtainableOnLoot, MobEffects.DIG_SPEED));
    }
