 ...
 *
 */
public class AbilityConduitPowerConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityConduitPowerConfig() {
        super("conduit_power",
                eConfig -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(), () -> rarity, () -> maxLevel, () -> xpPerLevel,
                        () -> obtainableOnPlayerSpawn, () -> obtainableOnMobSpawn, () -> obtainableOnCraft, () -> obtainableOnLoot, MobEffects.CONDUIT_POWER));
    }
