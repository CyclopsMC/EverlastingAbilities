 ...
 *
 */
public class AbilityInvisibilityConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityInvisibilityConfig() {
        super("invisibility",
                eConfig -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(), () -> rarity, () -> maxLevel, () -> xpPerLevel,
                        () -> obtainableOnPlayerSpawn, () -> obtainableOnMobSpawn, () -> obtainableOnCraft, () -> obtainableOnLoot, MobEffects.INVISIBILITY));
    }
