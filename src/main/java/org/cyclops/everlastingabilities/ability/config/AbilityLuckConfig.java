 ...
 *
 */
public class AbilityLuckConfig extends AbilityConfig<AbilityTypePotionEffectSelf> {
    ...
    public AbilityLuckConfig() {
        super("luck",
                eConfig -> new AbilityTypePotionEffectSelf(eConfig.getNamedId(), rarity, maxLevel, xpPerLevel, Effects.LUCK));
    }
