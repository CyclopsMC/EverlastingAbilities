...
import org.cyclops.everlastingabilities.ability.AbilityTypeSpecialFlight;
 ...
 * @author rubensworks
 */
public class AbilityTypeSpecialFlightSerializerConfig<M extends IModBase> extends AbilitySerializerConfig<AbilityTypeSpecialFlight, M> {

    public AbilityTypeSpecialFlightSerializerConfig(M mod) {
        super(mod, "special_flight", (eConfig) -> RecordCodecBuilder.mapCodec(builder -> builder
                .group(
                ...
                .apply(builder, AbilityTypeSpecialFlight::new))
        );
    }
}
