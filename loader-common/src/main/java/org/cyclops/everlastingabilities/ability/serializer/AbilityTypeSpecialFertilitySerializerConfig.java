 ...
 * @author rubensworks
 */
public class AbilityTypeSpecialFertilitySerializerConfig<M extends IModBase> extends AbilitySerializerConfig<AbilityTypeSpecialFertility, M> {

    public AbilityTypeSpecialFertilitySerializerConfig(M mod) {
        super(mod, "special_fertility", (eConfig) -> RecordCodecBuilder.mapCodec(builder -> builder
                .group(
