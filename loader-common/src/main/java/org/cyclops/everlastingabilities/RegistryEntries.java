...
public class RegistryEntries {
    ...
    public static final DeferredHolderCommon<RecipeSerializer<?>, CustomRecipe.Serializer<TotemRecycleRecipe>> RECIPESERIALIZER_TOTEM_RECYCLE = DeferredHolderCommon.create(Registries.RECIPE_SERIALIZER, ResourceLocation.parse("everlastingabilities:crafting_special_totem_recycle"));
