...
public class Attachments {
    ...
    public static void register() {
        LAST_FLIGHT = AttachmentRegistry.<Boolean>builder()
                ...
                .buildAndRegister(Identifier.fromNamespaceAndPath(Reference.MOD_ID, "last_flight"));
        TOTEM_SPAWNED = AttachmentRegistry.<Boolean>builder()
                .copyOnDeath()
                .persistent(Codec.BOOL)
                .buildAndRegister(Identifier.fromNamespaceAndPath(Reference.MOD_ID, "totem_spawned"));
        ABILITY_STORE = AttachmentRegistry.<IAbilityStore>builder()
                .copyOnDeath()
                .persistent(CodecHelpers.CODEC_ABILITY_STORE)
                .buildAndRegister(Identifier.fromNamespaceAndPath(Reference.MOD_ID, "ability_store"));
    }
